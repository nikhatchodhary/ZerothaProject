...
function ProductPage() {
    return ( 
        <>
            ...
            productName="Kite"
            productDescription="Our ultra-fast flagship trading 
            platform with streaming market data,
             advanced charts, an elegant UI, and more. Enjoy the Kite 
            ...
            in-depth coverage and illustrations.
            ...
            appStore=""
            />
            <p className='text-center fs-5' style={{fontWeight:"400,",color:"#504d4dff"}}>Want to know more about our technology stack? Check out the Zerodha.tech blog.
